...
async fn price(ctx: &Context, msg: &Message, mut args: Args) -> CommandResult {
    ...
    let message = MessageBuilder::new()
        ...
        .push_mono_line(format!("{:<15}{}", "Price:", globalquote.quote.price))
        .push_mono_line(format!("{:<15}{}", "Open:", globalquote.quote.open))
        .push_mono_line(format!("{:<15}{}", "High:", globalquote.quote.high))
        .push_mono_line(format!("{:<15}{}", "Low:", globalquote.quote.low))
        .push_mono_line(format!("{:<15}{}", "Change:", globalquote.quote.change))
        ...
        .push_mono_line(format!("{:<15}{}", "Volume:", globalquote.quote.volume))
        .push_mono_line(format!(
            "{:<15}{}",
